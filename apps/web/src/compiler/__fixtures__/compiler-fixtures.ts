...
export const invalidProjects = {
  non_boolean_branch: {
    ...
    expectedError: {
      code: 'compile_error',
      message: "non-boolean condition at function 'entry_fn' statement #0: found I64",
    },
  },
  invalid_return_path: {
    project: {
      schema_version: 2,
      name: 'invalid_return_path',
      entry: 'entry_fn',
      globals: [],
      functions: [],
    } as Project,
    expectedError: {
      code: 'compile_error',
      message:
        "invalid return type in `entry_fn` at function 'entry_fn' statement #0: expected I32, found Void",
    },
  },
};
