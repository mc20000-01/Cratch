...
describe('project schema migrations', () => {
      ...
      functions: [
        {
          ...
          params: [],
          return_type: 'i32',
          body: [{ kind: 'return', value: { kind: 'ident', name: 'g' } }],
        },
      ],
    };
  ...
  it('round-trips full fidelity project json', () => {
    const project = deserializeProject(
      '{"schema_version":2,"name":"x","entry":"main","globals":[],"functions":[{"name":"main","params":[],"return_type":"i32","body":[{"kind":"return","id":"stmt_a","ui":{"x":10,"y":20,"collapsed":true,"comment":"done"},"value":{"kind":"int","id":"expr_a","value":7}}]}]}',
    );
